This project consists of an extremely simple, server-side, Swift application based on Kitura that supports an AngularJS application loading data from the Kitura backend.
